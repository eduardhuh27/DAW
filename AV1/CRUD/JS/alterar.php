    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET')
    {
        ...
        if (!empty($matricula))
        {
            ...
            if (file_exists($caminho))
            {
                ...
                {
                     echo json_encode(["sucesso" => false, "mensagem" => "Erro:Aluno não encontrado para alteração."]);
                        exit;
        ...
        {
             echo json_encode(["sucesso" => false, "mensagem" => "Erro:Nenhum aluno selecionado para alteração. Faça a busca primeiro.."]);
                        exit;
